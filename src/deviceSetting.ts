...
class DeviceSettings {
    ...
    output: StrSetting;
    debugger: StrSetting;
    intelliSenseGen: StrSetting;
    configuration: StrSetting;
    prebuild: StrSetting;
    postbuild: StrSetting;
    programmer: StrSetting;
    buildPreferences: BuildPrefSetting;
    constructor() {
